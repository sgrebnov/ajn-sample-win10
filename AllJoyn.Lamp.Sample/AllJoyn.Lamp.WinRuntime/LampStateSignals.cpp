...
void LampStateSignals::LampStateChanged(_In_ Platform::String^ interface_lampID)
{
    ...
    TypeConversionHelpers::SetAllJoynMessageArg(alljoyn_msgarg_array_element(arguments, 0), "s", interface_lampID);
