...
public:
    ...
    Windows::Foundation::IAsyncOperation<LampStateTransitionLampStateResult^>^ TransitionLampStateAsync(_In_ uint64 interface_timestamp, _In_ Windows::Foundation::Collections::IMapView<Platform::String^,Platform::Object^>^ interface_newState, _In_ uint32 interface_transitionPeriod);
    // Call the ApplyPulseEffect method
    Windows::Foundation::IAsyncOperation<LampStateApplyPulseEffectResult^>^ ApplyPulseEffectAsync(_In_ Windows::Foundation::Collections::IMapView<Platform::String^,Platform::Object^>^ interface_fromState, _In_ Windows::Foundation::Collections::IMapView<Platform::String^,Platform::Object^>^ interface_toState, _In_ uint32 interface_period, _In_ uint32 interface_duration, _In_ uint32 interface_numPulses, _In_ uint64 interface_timestamp);
