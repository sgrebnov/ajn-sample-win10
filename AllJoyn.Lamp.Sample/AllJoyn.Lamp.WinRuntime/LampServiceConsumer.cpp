...
IAsyncOperation<LampServiceClearLampFaultResult^>^ LampServiceConsumer::ClearLampFaultAsync(_In_ uint32 interface_lampFaultCode)
{
    return create_async([this, interface_lampFaultCode]() -> LampServiceClearLampFaultResult^
    {
        ...
        TypeConversionHelpers::SetAllJoynMessageArg(alljoyn_msgarg_array_element(inputs, 0), "u", interface_lampFaultCode);
