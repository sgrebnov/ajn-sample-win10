...
IAsyncOperation<LampStateTransitionLampStateResult^>^ LampStateConsumer::TransitionLampStateAsync(_In_ uint64 interface_timestamp, _In_ Windows::Foundation::Collections::IMapView<Platform::String^,Platform::Object^>^ interface_newState, _In_ uint32 interface_transitionPeriod)
{
    return create_async([this, interface_timestamp, interface_newState, interface_transitionPeriod]() -> LampStateTransitionLampStateResult^
    {
        ...
        TypeConversionHelpers::SetAllJoynMessageArg(alljoyn_msgarg_array_element(inputs, 0), "t", interface_timestamp);
        TypeConversionHelpers::SetAllJoynMessageArg(alljoyn_msgarg_array_element(inputs, 1), "a{sv}", interface_newState);
        TypeConversionHelpers::SetAllJoynMessageArg(alljoyn_msgarg_array_element(inputs, 2), "u", interface_transitionPeriod);
...
IAsyncOperation<LampStateApplyPulseEffectResult^>^ LampStateConsumer::ApplyPulseEffectAsync(_In_ Windows::Foundation::Collections::IMapView<Platform::String^,Platform::Object^>^ interface_fromState, _In_ Windows::Foundation::Collections::IMapView<Platform::String^,Platform::Object^>^ interface_toState, _In_ uint32 interface_period, _In_ uint32 interface_duration, _In_ uint32 interface_numPulses, _In_ uint64 interface_timestamp)
{
    return create_async([this, interface_fromState, interface_toState, interface_period, interface_duration, interface_numPulses, interface_timestamp]() -> LampStateApplyPulseEffectResult^
    {
        ...
        TypeConversionHelpers::SetAllJoynMessageArg(alljoyn_msgarg_array_element(inputs, 0), "a{sv}", interface_fromState);
        TypeConversionHelpers::SetAllJoynMessageArg(alljoyn_msgarg_array_element(inputs, 1), "a{sv}", interface_toState);
        TypeConversionHelpers::SetAllJoynMessageArg(alljoyn_msgarg_array_element(inputs, 2), "u", interface_period);
        TypeConversionHelpers::SetAllJoynMessageArg(alljoyn_msgarg_array_element(inputs, 3), "u", interface_duration);
        TypeConversionHelpers::SetAllJoynMessageArg(alljoyn_msgarg_array_element(inputs, 4), "u", interface_numPulses);
        TypeConversionHelpers::SetAllJoynMessageArg(alljoyn_msgarg_array_element(inputs, 5), "t", interface_timestamp);
