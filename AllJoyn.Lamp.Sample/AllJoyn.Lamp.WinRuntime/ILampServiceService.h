...
public:
    ...
    Windows::Foundation::IAsyncOperation<LampServiceClearLampFaultResult^>^ ClearLampFaultAsync(Windows::Devices::AllJoyn::AllJoynMessageInfo^ info , _In_ uint32 interface_lampFaultCode);
